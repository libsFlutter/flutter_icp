...
void main() {
  group('NFT Marketplace Flow Integration Tests', () {
    ...
    testWidgets('Complete NFT marketplace workflow', (WidgetTester tester) async {
    ...
    testWidgets('NFT purchase workflow', (WidgetTester tester) async {
      ...
      final updatedListing = await marketplaceProvider.getListing(listingToBuy.id);
    ...
    testWidgets('Marketplace analytics workflow', (WidgetTester tester) async {
      ...
      final collectionStats = await marketplaceProvider.getCollectionStats(testContractAddress);
      ...
      final userAddress = walletProvider.connectedAddress!;
      final userActivity = await marketplaceProvider.getUserActivity(userAddress);
    ...
    testWidgets('Advanced search and filtering workflow', (WidgetTester tester) async {
      ...
      final contractFilteredListings = await marketplaceProvider.getActiveListings(
      ...
      final page1 = await marketplaceProvider.getActiveListings(limit: 2, offset: 0);
      final page2 = await marketplaceProvider.getActiveListings(limit: 2, offset: 2);
      expect(page1.length, lessThanOrEqualTo(2));
      expect(page2.length, lessThanOrEqualTo(2));
    });

    testWidgets('Error handling in marketplace workflows', (WidgetTester tester) async {
