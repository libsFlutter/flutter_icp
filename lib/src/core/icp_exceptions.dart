...
abstract class ICPException extends YukuException {
  const ICPException(String message, {String? code, dynamic details})
    : super(message, code: code, details: details);
}

/// Exception thrown when ICP canister is not available
class ICPCanisterNotAvailableException extends ICPException {
  const ICPCanisterNotAvailableException(
    String message, {
    String? code,
...
class ICPPrincipalInvalidException extends ICPException {
  const ICPPrincipalInvalidException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPAccountInvalidException extends ICPException {
  const ICPAccountInvalidException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPInsufficientBalanceException extends ICPException {
  const ICPInsufficientBalanceException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPAuthenticationException extends ICPException {
  const ICPAuthenticationException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPAuthorizationException extends ICPException {
  const ICPAuthorizationException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPConfigurationException extends ICPException {
  const ICPConfigurationException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPServiceNotInitializedException extends ICPException {
  const ICPServiceNotInitializedException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPServiceAlreadyInitializedException extends ICPException {
  const ICPServiceAlreadyInitializedException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPQuotaExceededException extends ICPException {
  const ICPQuotaExceededException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPCanisterFullException extends ICPException {
  const ICPCanisterFullException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPInsufficientCyclesException extends ICPException {
  const ICPInsufficientCyclesException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPInsufficientMemoryException extends ICPException {
  const ICPInsufficientMemoryException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPInsufficientStorageException extends ICPException {
  const ICPInsufficientStorageException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPInsufficientComputationException extends ICPException {
  const ICPInsufficientComputationException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
...
class ICPWalletNotConnectedException extends ICPException {
  const ICPWalletNotConnectedException(
    String message, {
    String? code,
    dynamic originalError,
  }) : super(message, code: code, originalError: originalError);
