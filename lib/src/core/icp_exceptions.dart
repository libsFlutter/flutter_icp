...
class ICPAuthenticationException extends ICPException {
  const ICPAuthenticationException(String message, {String? code, dynamic originalError})
      : super(message, code: code, originalError: originalError);
}

/// Exception thrown when ICP authorization fails
class ICPAuthorizationException extends ICPException {
  const ICPAuthorizationException(String message, {String? code, dynamic originalError})
      : super(message, code: code, originalError: originalError);
}
